...
<div class="row mt-5">
    <div class="col-lg-12 text-center">
        <h1><span class="text-primary">Electricity Miscellaneous</span> Records</h1>
        <h2><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newElec">New Electricity Misc Entry</button></h2>
...
<div class="modal fade" id="byDate" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog">
        ...
        <form class="modal-content" action="<?php echo e(route('admin.elecMiscResult')); ?>" method="get">
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Ezekiel B. Lim\Desktop\jim-tenant-management-system\resources\views/admin/misc/elecLanding.blade.php ENDPATH**/ ?>