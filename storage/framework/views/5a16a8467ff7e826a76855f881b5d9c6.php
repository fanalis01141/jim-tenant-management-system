            ...
            <div class="col-md-6">
                <div class="card p-1">
                    <div class="card-header">
                        <h4 class="card-title">Editing Information of User: <?php echo e(ucwords($user->name)); ?></h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <select name="level" id="level" class="form-control" required>
                                        ...
                                        <option value="admin" class="form-control" <?php echo e($user->level === 'admin' ? 'selected' : ''); ?>>Admin</option>
                                        <option value="encoder" class="form-control" <?php echo e($user->level === 'encoder' ? 'selected' : ''); ?>>Encoder</option>
                                        <option value="viewer" class="form-control" <?php echo e($user->level === 'viewer' ? 'selected' : ''); ?>>Viewer</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="new-password" placeholder="Enter new password.">
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Ezekiel B. Lim\Desktop\jim-tenant-management-system\resources\views/user/edit.blade.php ENDPATH**/ ?>