...
<div class="row">
    <div class="col-lg-12 text-center">
        <div class="row mt-3 d-flex justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <h3 class="card-header">You Are Viewing Payments For the Month Of <span class="text-primary"><?php echo e($readableDate); ?></span> </h3>
                              ...
                              <tbody>
                                    <?php $__currentLoopData = $tenantsPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(\Carbon\Carbon::parse($t->created_at)->format('M j, Y')); ?></td>
                                            <td class="align-items-start">
                                                ...
                                                <a class="btn btn-danger" onclick="deletePayment(<?php echo e($t->id); ?>)" href="#"><i class="bx bx-trash me-2"></i>Delete</a>                                            
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                               
                              </tbody>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Ezekiel B. Lim\Desktop\jim-tenant-management-system\resources\views/admin/payments/month.blade.php ENDPATH**/ ?>