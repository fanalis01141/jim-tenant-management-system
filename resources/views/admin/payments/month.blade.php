...
<div class="row">
    <div class="col-lg-12 text-center">
        <div class="row mt-3 d-flex justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <h3 class="card-header">You Are Viewing Payments For the Month Of <span class="text-primary">{{ $readableDate }}</span> </h3>
                              ...
                              <tbody>
                                    @foreach ($tenantsPayments as $t)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($t->created_at)->format('M j, Y') }}</td>
